...
export default function Show(){
    ...
    function Deletefun (email) {
        axios.delete("https://jfsd-spring-hosting-production-0b40.up.railway.app/delete", {params:{
            email: email
        }}).then((res)=>{
            alert(res.data);
            setResult(null)
    ...
    function saveEdit() {
        axios.put("https://jfsd-spring-hosting-production-0b40.up.railway.app/update", {
    ...
    if(result == null) {
        axios.get("https://jfsd-spring-hosting-production-0b40.up.railway.app/all", {}).then ((res)=>{
            setResult(res.data)
        })
    }
